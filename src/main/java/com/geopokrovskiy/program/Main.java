...
import com.geopokrovskiy.services.LoaderService;
...
public class Main {
    ...
    public static void main(String[] arg) {
        String link = "https://drive.google.com/uc?id=1P0_XKLUfOsGN59em8tFXc5GItil_Grw1&export=download";
        LoaderService loaderService = new LoaderService(link, "output.rar", "progress.txt");
        System.out.println(loaderService.load(link));
    }
}